...
int main(int argc, char **argv) {
  ...
  private_nh.param("grid_x", grid_x, 0.001);
  private_nh.param("grid_y", grid_y, 0.001);
  private_nh.param("grid_z", grid_z, 0.001);
  private_nh.param("thre_radius", thre_radius, 0.5);
  private_nh.param("map_resolution", map_resolution, 0.005);
